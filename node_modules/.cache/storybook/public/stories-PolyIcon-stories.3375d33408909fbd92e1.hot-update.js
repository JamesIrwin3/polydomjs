...
const PolyIcon = _ref => {
  ...
  const ref = (0,_Polygon_methods__WEBPACK_IMPORTED_MODULE_1__.useIcon)(Icon, iconScaleFactor);
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_Polygon__WEBPACK_IMPORTED_MODULE_2__.Polygon, {
    ...polygonProps,
...
const useIcon = (icon, scale, inCircleRadius) => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    const g = ref.current;
    const elems = Array.from(ref.current.children);
    elems.forEach(elem => {
...
/* harmony reexport (unknown) */ for(const __WEBPACK_IMPORT_KEY__ in _geometry_types__WEBPACK_IMPORTED_MODULE_1__) if(["default","add","aspect","calc","divide","invert","max","measure","min","multiply","ngon","operators","rad","ray","subtract","translate","uniform"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) __WEBPACK_REEXPORT_OBJECT__[__WEBPACK_IMPORT_KEY__] = () => _geometry_types__WEBPACK_IMPORTED_MODULE_1__[__WEBPACK_IMPORT_KEY__]
...
//# sourceMappingURL=stories-PolyIcon-stories.3375d33408909fbd92e1.hot-update.js.map