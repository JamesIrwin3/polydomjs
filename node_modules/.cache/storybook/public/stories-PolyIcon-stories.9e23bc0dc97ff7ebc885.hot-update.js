...
const useIcon = (icon, scale, inCircleRadius, offset) => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    Array.from(g.children).forEach(elem => {
      ...
      g.setAttribute('transform', `scale(${scale}) translate()`);
...
//# sourceMappingURL=stories-PolyIcon-stories.9e23bc0dc97ff7ebc885.hot-update.js.map