...
const useIcon = (icon, scale, inCircleRadius) => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    Array.from(g.children).forEach(elem => {
      ...
      const scale = inCircleRadius * 2 / maxDim;
      console.log(vb, inCircleRadius, maxDim, scale);
    });
  }, [icon]);
  return ref;
};
...
//# sourceMappingURL=src_components_index_ts.dc2a53565b7acaa48259.hot-update.js.map