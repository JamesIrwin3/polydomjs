...
/* harmony import */ var _geometry__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../geometry */ "./src/geometry/geometry.methods.ts");
...
const Polygon = _ref => {
  let {
    ...
    strokeColor = '#000',
    lineWidth = 0.1,
    children = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(react_icons_fa__WEBPACK_IMPORTED_MODULE_2__.FaBeer, {})
  } = _ref;
  const [points, viewBox] = (0,_geometry__WEBPACK_IMPORTED_MODULE_3__.ngon)(sides, scale, (0,_geometry__WEBPACK_IMPORTED_MODULE_3__.rad)(rotation), cornerRadius, [0, 0]);
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (nextChild.tagName === 'svg') {
      const childViewBox = nextChild.getAttribute('viewBox');
      console.log("do something with this", nextChild.getAttribute('viewBox'));
    }
  }, []);
...
//# sourceMappingURL=stories-Polygon-stories.c499cdc5577bc20bb350.hot-update.js.map