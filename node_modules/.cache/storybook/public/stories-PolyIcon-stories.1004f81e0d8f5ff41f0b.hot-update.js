...
const useNgon = (sides, scale, rotation, cornerRadius, strokeWidth) => {
  ...
  const [points, viewBox] = (0,_geometry__WEBPACK_IMPORTED_MODULE_1__.ngon)(sides, radius, rotation, cornerRadius, (0,_geometry__WEBPACK_IMPORTED_MODULE_1__.uniform)(radius, 2));
  console.log(viewBox);
  return;
};
...
const Polygon = _ref => {
  ...
  (0,_Polygon_methods__WEBPACK_IMPORTED_MODULE_3__.useNgon)(sides, scale, rotation, cornerRadius, strokeWidth);
...
//# sourceMappingURL=stories-PolyIcon-stories.1004f81e0d8f5ff41f0b.hot-update.js.map