...
try {
    ...
    Path.displayName = "Path";
    // @ts-ignore
    Path.__docgenInfo = { "description": "", "displayName": "Path", "props": { "points": { "defaultValue": { value: "[]" }, "description": "Renders based on points rather then string. \n2 coordinate points provided will result in a line (or movement if first point)\n4 coordinate points provided will result in a cubic curve", "name": "points", "required": false, "type": { "name": "number[][]" } }, "fill": { "defaultValue": null, "description": "The fill color", "name": "fill", "required": false, "type": { "name": "string" } }, "stroke": { "defaultValue": null, "description": "The stroke color", "name": "stroke", "required": false, "type": { "name": "string" } }, "strokeWidth": { "defaultValue": { value: "0" }, "description": "The stroke width", "name": "strokeWidth", "required": false, "type": { "name": "number" } }, "scale": { "defaultValue": { value: "1" }, "description": "scale will allow path to adjust border size", "name": "scale", "required": false, "type": { "name": "number" } } } };
    // @ts-ignore
...
//# sourceMappingURL=stories-Polygon-stories.49df1ab0efcaafba8bf5.hot-update.js.map