...
const useNgon = (sides, scale, rotation, cornerRadius, strokeWidth) => {
  ...
  const [cpts, vb] = (0,_geometry__WEBPACK_IMPORTED_MODULE_1__.ngon)(sides, radius, rotation, cornerRadius, [0, 0]);
  const points = (0,_geometry__WEBPACK_IMPORTED_MODULE_1__.translate)(cpts, [vb[0], vb[1], vb[0], vb[1]]);
  const viewBox = [0, 0, vb[2] * 2, vb[3] * 2];
  return;
};
...
//# sourceMappingURL=stories-PolyIcon-stories.e5151fe06f0891889ef1.hot-update.js.map