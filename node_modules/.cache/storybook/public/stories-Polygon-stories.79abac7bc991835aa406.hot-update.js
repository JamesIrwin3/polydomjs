...
const add = (point, additor) => {
  ...
  if (multiply.length !== point.length) throw `Unable to add non parallel arrays ${point.length} ${additing.length}`;
...
//# sourceMappingURL=stories-Polygon-stories.79abac7bc991835aa406.hot-update.js.map