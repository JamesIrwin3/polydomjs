...
try {
    ...
    Path.displayName = "Path";
    // @ts-ignore
    Path.__docgenInfo = { "description": "", "displayName": "Path", "props": { "points": { "defaultValue": { value: "[]" }, "description": "Renders based on points rather then string. \n2 coordinate points provided will result in a line (or movement if first point)\n4 coordinate points provided will result in a cubic curve", "name": "points", "required": false, "type": { "name": "number[][]" } }, "fill": { "defaultValue": null, "description": "The fill color", "name": "fill", "required": true, "type": { "name": "string" } }, "stroke": { "defaultValue": null, "description": "The stroke color", "name": "stroke", "required": true, "type": { "name": "string" } }, "strokeWidth": { "defaultValue": null, "description": "The stroke width", "name": "strokeWidth", "required": true, "type": { "name": "string" } } } };
    // @ts-ignore
...
//# sourceMappingURL=stories-Polygon-stories.4638082273734088fd3a.hot-update.js.map