...
const PolyIcon = _ref => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const g = ref.current;
    if (g.children.length === 0 || g.children[0].tagName !== 'svg') return;
    const iconSvg = g.children[0];
    console.log(iconSvg);
  }, []);
...
//# sourceMappingURL=stories-PolyIcon-stories.3ed56e9a70f386f73ba9.hot-update.js.map