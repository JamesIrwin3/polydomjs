...
/***/ "./src/stories/PolyImg.stories.tsx":
/*!*****************************************!*\
  !*** ./src/stories/PolyImg.stories.tsx ***!
  \*****************************************/
...
const meta = {
  ...
  component: _components__WEBPACK_IMPORTED_MODULE_0__.PolyImg,
  parameters: {
    layout: 'centered'
  },
  tags: ['autodocs']
...
const PolyImg = _ref => {
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_Svg__WEBPACK_IMPORTED_MODULE_1__.Svg, {
    viewBox: viewBox,
    width: "100%",
    height: "100%",
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_Svg__WEBPACK_IMPORTED_MODULE_1__.Path, {
...
const useNgon = (sides, scale, rotation, cornerRadius, strokeWidth) => {
  const [stateScale, setStateScale] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(scale);
  const [ssw, scr] = (0,_geometry__WEBPACK_IMPORTED_MODULE_1__.multiply)([strokeWidth, cornerRadius], stateScale);
  const radius = stateScale / 2;
  ...
  return [points, [0, 0, bvb[2], bvb[3]], ssw, setStateScale];
};
...
//# sourceMappingURL=stories-PolyImg-stories.19430f5b659c16d814cc.hot-update.js.map