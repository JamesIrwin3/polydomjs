...
const PolyIcon = _ref => {
  ...
  const apx = (0,_geometry__WEBPACK_IMPORTED_MODULE_3__.apothem)(sides);
  console.log(apx, dimensions);
  const difference = (0,_geometry__WEBPACK_IMPORTED_MODULE_3__.subtract)((0,_geometry__WEBPACK_IMPORTED_MODULE_3__.divide)(dimensions, 2), apx);
  const offset = [];
  const ref = (0,_Polygon_methods__WEBPACK_IMPORTED_MODULE_1__.useIcon)(Icon, iconScaleFactor, (0,_geometry__WEBPACK_IMPORTED_MODULE_3__.apothem)(sides));
...
//# sourceMappingURL=src_components_index_ts.2411ceb450ad3fced64b.hot-update.js.map