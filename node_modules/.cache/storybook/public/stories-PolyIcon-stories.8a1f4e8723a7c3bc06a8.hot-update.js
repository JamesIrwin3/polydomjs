...
const useNgon = (sides, scale, rotation, cornerRadius, strokeWidth) => {
  ...
  const tvp = [-bvb[0], -bvb[1]];
  const points = (0,_geometry__WEBPACK_IMPORTED_MODULE_0__.translate)(cpts, [...tvp, ...tvp]);
...
translationParams: ${tvp}
	...
	`);
  return [points, bvb, ssw];
};

/***/ })

});
//# sourceMappingURL=stories-PolyIcon-stories.8a1f4e8723a7c3bc06a8.hot-update.js.map