...
const multiply = (point, multiplier) => {
  ...
  if (mult.length != point.length) throw "Unable to multiply non parallel arrays";
...
const add = (point, additor) => {
  ...
  if (multiply.length != point.length) throw "Unable to add non parallel arrays";
...
//# sourceMappingURL=stories-Polygon-stories.27a91cbe8499d18e8913.hot-update.js.map